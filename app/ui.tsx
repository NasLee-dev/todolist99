...
export default function UI() {
  ...
  const { data: todoList, refetch, isLoading } = useGetTodos({ searchInput })
  const addTodo = useCreateTodo({ searchInput, refetch, setSearchInput })
  return (
    <div className="flex w-full max-w-2xl mx-auto flex-col items-center py-10 gap-5">
